...
## Zagon
Projekt se zažene preko glavne datoteke main.py, ki zaporedno izvede vse potrebne ukaze za analizo podatkov. 

## Rezultati
Rezultati in ugotovitve so zabeleženi v zaključku datoteke analiza_podatkov.ipynb. 